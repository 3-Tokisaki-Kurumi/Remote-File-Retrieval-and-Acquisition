...
#define SERVER_IP               "192.168.1.100" // 服务器实际IP地址
#define SERVER_PORT             9000    // 服务器端口,例如9000,需要保证服务器端口可用
#define BUFFER_SIZE             (4 * 1024 * 1024)   // 4MB 缓冲区
#define SIZE_30MB               (30 * 1024 * 1024)   // 30MB 大文件阈值
